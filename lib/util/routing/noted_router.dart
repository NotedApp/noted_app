...
abstract class NotedRouter {
  ...
  void maybePop<T extends Object?>(BuildContext context, {T? result = null});
}
...
extension NotedRouterExtension on BuildContext {
  ...
  void pop<T extends Object?>({T? result = null}) => locator<NotedRouter>().pop(this, result: result);
  void mayblePop<T extends Object?>({T? result = null}) => locator<NotedRouter>().maybePop(this, result: result);
}
