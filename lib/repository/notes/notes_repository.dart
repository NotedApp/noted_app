...
abstract class NotesRepository {
  ...
  Future<Stream<List<NotedNote>>> subscribeNotes({required String userId});

  /// Adds a note for the given user, returning the ID of the note that was added.
  Future<String> addNote({required String userId, required NotedNote note});

  /// Updates the given note for the given user.
  Future<void> updateNote({required String userId, required NotedNote note});
