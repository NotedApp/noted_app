...
import 'package:noted_models/noted_models.dart' as noted;
...
class QuillEditorController extends NotedEditorController {
  ...
  @override
  Stream<noted.DocumentModel> get valueStream => controller.changes.map((event) => value);

  @override
  set value(noted.DocumentModel document) => controller.document = Document.fromJson(document);
