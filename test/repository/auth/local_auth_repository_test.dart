...
void main() {
  final UserModel expected = UserModel(id: 'local-11', name: 'Local 11', email: 'email');
  final UserModel local = UserModel(id: 'local-0', email: 'local-0@noted.com', name: 'shaquille.oatmeal');
  ...
  group('LocalAuthRepository', () {
    ...
    test('signs in with google', () async {
      UserModel expected = UserModel(id: 'local-google', name: 'googly_woogly', email: 'local-google@noted.com');
